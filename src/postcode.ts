 ...
 */
const rePostcode = /\b(([A-Z]{1,2}[0-9][A-Z0-9]?|0[LX]\d{1,2}|ASCN|STHL|TDCU|BBND|[BFS]IQQ|PCRN|TKCA)\s?[0-9][A-Z]{2}|BFPO\s?[0-9]{1,4}|(KY[0-9]|MSR|VG|AI)[\s-]?[0-9]{4}|GE\s?CX|GIR\s?0A{2}|SAN\s?TA1)\b/gi;
